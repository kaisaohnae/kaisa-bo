...
const routes: RouteRecordRaw[] = [
  ...
  {path: '/:pathMatch(.*)*', name: '404', meta: {title: '404'}, component: () => import('@/views/error/404.vue')},
  {
    ...
    children: [
      ...
      {path: '/at/menu-company-role', name: 'menuCompanyRole', meta: {title: '메뉴업체권한', auth: true}, component: () => import('@/views/at/menu-company-role.vue'),},
      ...
      {path: '/od/holiday-price', name: 'holidayPrice', meta: {title: '휴일가격', auth: true}, component: () => import('@/views/od/holiday-price.vue'),},
      ...
      {path: '/od/season-price', name: 'seasonPrice', meta: {title: '시즌가격', auth: true}, component: () => import('@/views/od/season-price.vue'),},
