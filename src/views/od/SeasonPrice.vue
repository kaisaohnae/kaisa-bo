      ...
      <table>
        ...
        <tbody>
            ...
            <tr>
              ...
              <td colspan="3"><input type="text" v-model="search.seasonPriceName"/></td>
            </tr>
        </tbody>
...
import SeasonPriceService from '@src/service/od/SeasonPriceService';
...
const getList = () => {
  SeasonPriceService.getSeasonPriceList({
    ...search,
...
const save = () => {
  ...
  SeasonPriceService.setSeasonPriceList(saveList).then(() => {
    getList(); // 저장 후 목록 갱신
  });
};
onMounted(() => {
