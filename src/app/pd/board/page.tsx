...
export default function BoardPage() {
  ...
  const save = async () => {
    ...
    if (!saveList) return;
    BoardService.setBoardList(saveList).then(async () => {
      await getList();
    });
  };
    ...
    <>
      ...
      >
        ...
        <div className="buttons">
          <CrudButtons menuId="pd-board" add={add} del={del} save={save} />
      ...
      {detailShow && (
       <>
         <Detail component={BoardDetail} detailData={detailData} detailShow={detailShow} setDetailShow={setDetailShow} getList={getList} />
       </>
      )}
