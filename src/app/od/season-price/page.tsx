...
export default function SeasonPricePage() {
  ...
  useEffect(() => {
    ...
    handsontable.current = new Handsontable(gridRef.current, {
      ...
      {data: 'seasonPriceName', type: 'text', width: 100,   },
      {data: 'hotWaterPrice', type: 'numeric', width: 100,   },
      {data: 'bbqPrice', type: 'numeric', width: 100,   },
      {data: 'headCountOverPrice', type: 'numeric', width: 100,   },
      {data: 'petPrice', type: 'numeric', width: 100,   },
      {data: 'pickupPrice', type: 'numeric', width: 100,   },
    ...
    <>
      ...
      >
        ...
        <div className="buttons">
          <CrudButtons menuId="od-season-price" add={add} del={del} save={save} />
          ...
          <button type="button" className="button excel" onClick={() => excelUtil.excelExport(handsontable.current, '시즌가격')}>
