...
export default function SeasonPage() {
  ...
  useEffect(() => {
    ...
    handsontable.current = new Handsontable(gridRef.current, {
      ...
      {data: 'seasonNo', type: 'numeric', width: 100, readOnly: true,  },
      {data: 'seasonPriceNo', type: 'numeric', width: 100,   },
      {data: 'companyId', type: 'text', width: 100, readOnly: true,  },
      {data: 'sortOrder', type: 'numeric', width: 100,   },
      {data: 'seasonName', type: 'text', width: 100,   },
      {data: 'seasonStartDay', type: 'text', width: 120,   ...gridUtil.datePickerConfig },
      {data: 'seasonEndDay', type: 'text', width: 120,   ...gridUtil.datePickerConfig },
      {data: 'price', type: 'numeric', width: 90,   },
      {data: 'friPrice', type: 'numeric', width: 90,   },
      {data: 'satPrice', type: 'numeric', width: 90,   },
      {data: 'sunPrice', type: 'numeric', width: 90,   },
    ...
    <>
      ...
      >
        ...
        <div className="buttons">
          <CrudButtons menuId="od-season" add={add} del={del} save={save} />
